...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_DotCreator p_DotCreator;
        ...
        public static SteamVR_Input_ActionSet_DotCreator DotCreator
        {
            get
            {
                return SteamVR_Actions.p_DotCreator.GetCopy<SteamVR_Input_ActionSet_DotCreator>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_DotCreator = ((SteamVR_Input_ActionSet_DotCreator)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_DotCreator>("/actions/DotCreator")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.DotCreator};
        }
    }
}
